...
2. Create/update a page under `practice-app/src/app/<section>/<item>/page.js` with:
...
3. Tell the student to run `npm run dev` inside `practice-app/` and open the page themselves - do not run it or read its output yourself.
